                ...
                <div class="card-body">
                    <div class="tab">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <x-install-select label="App Environment" class="form-control" required="ture"
                                    name="environment">
                            ...
                            <div class="col-md-4 mb-3">
                                <x-install-select label="App Log Level" class="form-control" required="ture"
                                    name="app_log_level">
                            ...
                            <div class="col-md-4 mb-3">
                                <x-install-input label="Database Host" required="ture" name="database_hostname"
                            ...
                            <div class="col-md-4 mb-3">
                                <x-install-input label="Database User Name" required="ture" name="database_username"
                            ...
                            <div class="col-md-4 mb-3">
                                <x-install-input label="Codecanyon Username" required="ture" name="codecanyon_username"
                                    type="text" value="{{ old('codecanyon_username') }}" />
                                <x-install-error for="codecanyon_username" />
                            </div>

                            <div class="col-md-4 mb-3">
                                <x-install-input label="Purchase Code" name="purchase_code" required="ture"
                                    type="text" value="{{ old('purchase_code') }}" />
                                <x-install-error for="purchase_code" />
                            </div>
