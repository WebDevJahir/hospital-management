...
@section('main_content')
    @parent
    @php
        $form_heading = $opd_patient_info ? 'Edit OPD Prescription' : 'Add OPD Prescription';
        $form_url = $opd_patient_info ? route('opd-prescription.update', $opd_patient_info->id) : route('opd-prescription.store');
        $form_method = $opd_patient_info ? 'PUT' : 'POST';
    @endphp
            ...
            <div class="fixedBodyScroll">
                <form action="{{ $form_url }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="table-container">
                                ...
                                <div class="th-title">
                                    <div style="">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <span class="th-count"><a href="{{ route('opd-prescription.index') }}"
                        ...
                        <div class="card"
                            style="border: 1px #dddddd solid; box-shadow: inset 0px 0px 6px 0px $dddddd; margin-top:5px;">
                            <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="name" id="name" class="form-control"
                                                    ...
                                                    value="{{ !empty($opd_patient_info) ? $opd_patient_info->name : '' }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select name="blood_group" class="form-control select2">
                                                    ...
                                                    <option @if (isset($opd_patient_info) && $opd_patient_info->blood_group == 'A+') selected @endif
                                                        value="A+">A+
                                                    </option>
                                                    <option @if (isset($opd_patient_info) && $opd_patient_info->blood_group == 'B+') selected @endif
                                                        value="B+">
                                                        B+</option>
                                                    <option @if (isset($opd_patient_info) && $opd_patient_info->blood_group == 'AB+') selected @endif
                                                        value="AB+">AB+
                                                    </option>
                                                    <option @if (isset($opd_patient_info) && $opd_patient_info->blood_group == 'O+') selected @endif
                                                        value="O+">O+
                                                    </option>
                                                    <option @if (isset($opd_patient_info) && $opd_patient_info->blood_group == 'A-') selected @endif
                                                        value="A-">A-
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select name="gender" class="form-control" readonly>
                                                    ...
                                                    <option @if (isset($opd_patient_info) && $opd_patient_info->gender == 'Male') selected @endif
                                                        value="Male">
                                                        Male </option>
                                                    <option @if (isset($opd_patient_info) && $opd_patient_info->gender == 'Female') selected @endif
                                                        value="Female">
                                                        Female </option>
                                                </select>
                                            </div>
                                                ...
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text custom-group-text">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                            height="16" fill="currentColor" class="bi bi-capsule"
                                                            viewBox="0 0 16 16">
                                                            <path
                                                                d="M1.828 8.9 8.9 1.827a4 4 0 1 1 5.657 5.657l-7.07 7.071A4 4 0 1 1 1.827 8.9Zm9.128.771 2.893-2.893a3 3 0 1 0-4.243-4.242L6.713 5.429l4.243 4.242Z" />
                                                        </svg>
                                                    </span>
                                                    <input list="medicines" type="text" name="medicine"
                                                        id="medicine" class="form-control">
