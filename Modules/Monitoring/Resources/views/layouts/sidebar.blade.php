<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="formsDropdown">
        ...
        @if (in_array(127, $permission))
            <li>
                <a class="dropdown-toggle sub-nav-link text-decoration-none" href="m_investigation.html"><span class="icon-search1"></span>
                    Prescription</a>
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="customDropdown">
                    @if (in_array(128, $permission))
                        <li>
                            <a class="dropdown-item" href="{{ route('prescription.index') }}"><span
                    ...
                    @if (in_array(129, $permission))
                        <li>
                            <a class="dropdown-item" href="{{ route('death-certificate.index') }}"><i
        ...
        @if (in_array(140, $permission))
            <li>
                <a class="dropdown-toggle sub-nav-link text-decoration-none" href="m_investigation.html"><span
                        class="icon-search1"></span>
                    Investigation</a>
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="customDropdown">
                    @if (in_array(145, $permission))
                        <li>
                            <a class="dropdown-item" href="{{ route('investigation-categories.index') }}"><i
                                    class="icon-printer nav-icon"></i> Category</a>
                        </li>
                    @endif
                    @if (in_array(149, $permission))
                        <li>
                            <a class="dropdown-item" href="{{ route('investigation-sub-categories.index') }}"><i
                                    class="icon-printer nav-icon"></i> Sub Category</a>
                        </li>
                    @endif
                    @if (in_array(141, $permission))
                        <li>
                            <a class="dropdown-item" href="{{ url('investigation-reports-list') }}"><i
        ...
        @if (in_array(153, $permission))
            <li>
                <a class="dropdown-toggle sub-nav-link text-decoration-none" href="#" id="customDropdown" role="button"
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="customDropdown">
                    @if (in_array(154, $permission))
                        <li>
                            <a class="dropdown-item" href="{{ url('patient-pain-asmt-list') }}"><i
                                    class="icon-edit1 nav-icon"></i>Assessment</a>
                        </li>
                    @endif
                    @if (in_array(157, $permission))
                        <li>
                            <a class="dropdown-item" href="{{ url('patient-morphin-list') }}"><i
                                    class="icon-edit1 nav-icon"></i>Management</a>
                        </li>
                    @endif
                    @if (in_array(160, $permission))
                        <li>
                            <a class="dropdown-item" href="{{ url('patient-morphin-dose-list') }}"><i
            ...
            <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="customDropdown">
                    @if (in_array(164, $permission))
                        <li>
                            <a class="dropdown-item" href="{{ url('patient-wound-list') }}"><i
                                    class="icon-edit1 nav-icon"></i>Wound Describe</a>
                        </li>
                    @endif
                    @if (in_array(167, $permission))
                        <li>
                            <a class="dropdown-item" href="{{ url('patient-wound-asst-list') }}"><i
                                    class="icon-edit1 nav-icon"></i>Wound Assesment</a>
                        </li>
                    @endif
                    @if (in_array(170, $permission))
                        <li>
                            <a class="dropdown-item" href="{{ url('patient-wound-manage-list') }}"><i
        ...
        @if (in_array(240, $permission))
            <li>
                <a class="dropdown-item" href="{{ url('patient-psycho-asmt-list') }}"><span class="icon-image"></span>
                    Phycho ASMT</a>
            </li>
        @endif
            ...
            <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="customDropdown">
                    @if (in_array(174, $permission))
                        <li>
                            <a class="dropdown-item" href="{{ url('menu-list') }}"><span class="icon-list2"></span>
                                Menu</a>
                        </li>
                    @endif
                    @if (in_array(178, $permission))
                        <li>
                            <a class="dropdown-item" href="{{ url('video-link-list') }}"><span
        ...
        @if (in_array(182, $permission))
            <li>
                <a class="dropdown-item" href="{{ url('all-uploads') }}"><span class="icon-image"></span> Uploaded
                    Documents</a>
            </li>
        @endif
    </ul>
