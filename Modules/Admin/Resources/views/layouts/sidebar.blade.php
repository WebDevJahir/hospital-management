    ...
    <ul class="dropdown-menu" aria-labelledby="appsDropdown">
        <li>
            ...
            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="calendarsDropdown">
                ...
                <li>
                    <a class="dropdown-item" href="http://index-medicare-new-v1.test/user-permission/init">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-shield-slash" viewBox="0 0 16 16">
        ...
        {{-- <li>
            ...
            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="calendarsDropdown">
                <li>
                    <a class="dropdown-item" href="http://index-medicare-new-v1.test/add-vat">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li>
                    <a class="dropdown-item" href="http://index-medicare-new-v1.test/admin/banners">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <li>
            ...
            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="calendarsDropdown">
                <li>
                    <a class="dropdown-item" href="{{ route('income-head.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li>
                    <a class="dropdown-item" href="{{ route('income-sub-category.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li>
                    <a class="dropdown-item" href="{{ route('expense-sub-category.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                {{-- <li>
                    <a class="dropdown-item" href="http://index-medicare-new-v1.test/admin/packages">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <li>
            ...
            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="calendarsDropdown">
                <li>
                    <a class="dropdown-item" href="http://index-medicare-new-v1.test/admin/district">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li>
                    <a class="dropdown-item" href="http://index-medicare-new-v1.test/admin/police-station">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-geo-alt" viewBox="0 0 16 16">
                            <path
                                d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A32 32 0 0 1 8 14.58a32 32 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304 7.867 3 6.862 3 6a5 5 0 0 1 10 0c0 .862-.305 1.867-.834 2.94M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10" />
                ...
                <li>
                    <a class="dropdown-item" href="http://index-medicare-new-v1.test/admin/promo-codes">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li>
                    <a class="dropdown-item" href="http://index-medicare-new-v1.test/admin/delivery-charge">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li>
                    <a class="dropdown-item" href="http://index-medicare-new-v1.test/admin/service-charge">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li>
                    <a class="dropdown-item" href="http://index-medicare-new-v1.test/admin/medical-support">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li>
                    <a class="dropdown-item" href="http://index-medicare-new-v1.test/admin/medical-procedure">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li>
                    <a class="dropdown-item" href="http://index-medicare-new-v1.test/admin/instrument"
                        aria-expanded="false">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li>
                    <a class="dropdown-item" href="http://index-medicare-new-v1.test/admin/allied-health">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
