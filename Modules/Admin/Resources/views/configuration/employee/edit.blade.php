                ...
                <div class="row gutters">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="table-container">
                            <div class="t-header">Employee Entry</div>
                            <hr />
                            <form action="{{ route('employee.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card">
                                                ...
                                                <div class="row gutters">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <div class="input-group mb-3">
                                                                <span
                                                                    class="input-group-text custom-group-text">Email</span>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <div class="input-group mb-3">
                                                                <span
                                                                    class="input-group-text custom-group-text">Gender</span>
                                                                <select class="form-control" name="gender">
                                                                    <option value="Male"
                                                                        @if (!empty($employee) && $employee->gender == 'Male') selected @endif>
                                                                        Male</option>
                                                                    <option value="Female"
                                                                        @if (!empty($employee) && $employee->gender == 'Female') selected @endif>
                                                                        Female</option>
                                                                    <option value="Other"
                                                                        @if (!empty($employee) && $employee->gender == 'Other') selected @endif>
                                                                        Other</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <div class="input-group mb-3">
                                                                <span
                                                                    class="input-group-text custom-group-text">Password</span>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <div class="input-group md-3">
                                                                <span
                                                                    class="input-group-text custom-group-text">Alternative
                                                                    Con</span>
                                                                <input type="number" class="form-control"
                                                ...
                                                <div class="row gutters">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <div class="input-group md-3">
                                                                <span
                                                                    class="input-group-text custom-group-text">Designation
                                                                    *</span>
                                                                <input type="text" class="form-control"
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <div class="input-group md-3">
                                                                <span class="input-group-text custom-group-text">Role
                                                                    *</span>
                                                            ...
                                                            <div class="input-group md-3">
                                                                ...
                                                                <select class="form-control" id="role"
                                                                    ...
                                                                    <option value="On Call"
                                                                        @if (!empty($employee) && $employee->employee_type == 'On Call') selected @endif>On
                                                                        Call</option>
                                                                    <option value="Roster"
                                                                        @if (!empty($employee) && $employee->employee_type == 'Roster') selected @endif>
                                                                        Roster</option>
                                                                    <option value="Monthly salary"
                                                                        @if (!empty($employee) && $employee->employee_type == 'Monthly salary') selected @endif>
                                                                        Monthly salary
                                                                    </option>
                                                                </select>
                                                            </div>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <div class="input-group mb-3">
                                                                <span
                                                                    class="input-group-text custom-group-text">Roster</span>
                                                                <input type="number" class="form-control"
                                                                    placeholder="Roster" name="roster"
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <div class="input-group mb-3">
                                                                <span
                                                                    class="input-group-text custom-group-text">Food</span>
                                                                <input type="number" class="form-control"
                                                                    placeholder="Food" name="food"
                                                                    value="{{ $employee->food ?? '' }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <div class="input-group mb-3">
                                                                <span
                                                                    class="input-group-text custom-group-text">Night</span>
                                                                <input type="number" class="form-control"
                                                                    placeholder="Night" name="night"
                                                                    value="{{ $employee->night ?? '' }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                ...
                                                <div class="row gutters">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <div class="input-group mb-3">
                                                                <span
                                                                    class="input-group-text custom-group-text">Conveyance</span>
                                                                <input type="number" class="form-control"
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <div class="input-group mb-3">
                                                                <span
                                                                    class="input-group-text custom-group-text">Increment</span>
                                                                <input type="number" class="form-control"
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <span
                                                                    class="input-group-text custom-group-text">Bonus</span>
                                                                <input type="number" class="form-control"
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <div class="input-group mb-3">
                                                                <span
                                                                    class="input-group-text custom-group-text">Deduction</span>
                                                                <input type="number" class="form-control"
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <select class="form-control" id="status"
                                                                    ...
                                                                    <option value="Active"
                                                                        @if (!empty($employee) && $employee->status == 'Active') selected @endif>
                                                                        Active</option>
                                                                    <option value="Not Active"
                                                                        @if (!empty($employee) && $employee->status == 'Not Active') selected @endif>
                                                                        Not Active
                                                                    </option>
                                                                </select>
                                                            </div>
                                    ...
                                    <div class="card-footer">
                                        <button class="btn btn-outline-primary tn-lg" type="submit">Save</button>
                                    </div>
                                </div>
                            </form>
                        </div>
