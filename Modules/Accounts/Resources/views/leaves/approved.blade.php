                                            ...
                                            <tr id="tr{{ $leave->id }}">
                                                ...
                                                <td>
                                                    @if (in_array(277, $permission))
                                                        <button onclick="LeaveView({{ $leave->id }})" class="btn btn-sm"
                                                            type="submit" style="background:inherit" title="View"
                                                    ...
                                                    @if (in_array(278, $permission))
                                                        <a href="{{ url('unapprove-leave', $leave->id) }}"
                                                            class="btn  btn-sm" style="background:inherit" title="Pending"
                                                            style="cursor: pointer; padding-right: 5px;"><i
                                                                class="fas fa-undo text-warning"></i></a>|
                                                    @endif
