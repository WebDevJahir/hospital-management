                        ...
                        <div id="example-form">
                            ...
                            <section>
                                <div class="row gutters">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="Phone number"
                                                    id="phone" name="phone" value="{{ $patient->phone ?? '' }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">Select Religion</span>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">Nationality</span>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">Sex *</span>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">Blood Group</span>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">Marital Status</span>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">NID/Passport
                                                    Number:</span>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">Occupation:</span>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">Doctor Contacting
                                                    Number:</span>
                                                <input type="text" class="form-control"
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">Key Family Contact
                                                    Person:</span>
                                                <input type="text" class="form-control"
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">Relation of Key Family
                                                    Contact Person:</span>
                                                <input type="text" class="form-control"
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">Total Family
                                                    Member</span>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">Social Status:</span>
                                    ...
                                    <div class="text-center">
                                        <button class="btn btn-success btn-lg" id="addpatientDetails"
                                            onclick="addpatientDetails()" type="button">Submit</button>
                                    </div>
                                </div>
                            </section>
                            <h3>Referral</h3>
                            <section>
                                <div class="row gutters">
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">Hospital Name:</span>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">Referring Doctor
                                                    Name:</span>
                                                <input type="text" class="form-control"
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">Agent Name:</span>
                                                <input type="text" class="form-control" placeholder="Agent Name"
                                                    id="agent_name" name="agent_name"
                                                    value="{{ $patient->patientReferral->agent_name ?? '' }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">Referring Patient
                                                    Family’s
                                                    Name:</span>
                                                <input type="number" class="form-control"
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">Where Know About
                                                    Us:</span>
                                                <select class="form-control" id="where_to_know" name="where_to_know">
                                ...
                                <div class="text-center"><button class="btn btn-success btn-lg">Submit</button></div>
                            </section>
                            ...
                            <section>
                                <div class="row gutters">
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">Primary diagnosis &
                                                    co-morbidities:</span>
                                                <input type="text" class="form-control"
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">How long is
                                                    suffering:</span>
                                                <input type="text" class="form-control"
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">Sites of
                                                    metastases:</span>
                                                <input type="text" class="form-control"
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">Prognosis:</span>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text custom-group-text">Food & medicine allergy
                                                    :</span>
                                                <input type="text" class="form-control"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="checkbox" @if (in_array('Pain & symptoms control', $referrals)) checked @endif
                                                    style="margin-left:5px;margin-top: 3px; " name="referral[]"
                                                    value="Pain & symptoms control"><span style="margin-left:10px">Pain &
                                                    symptoms control</span>
                                                <input type="checkbox" @if (in_array('Psychological support', $referrals)) checked @endif
                                                    style="margin-left:5px;margin-top: 3px; " name="referral[]"
                                                    value="Psychological support"><span
                                                    style="margin-left:10px">Psychological support</span>
                                                <input type="checkbox" @if (in_array('Drug Titration', $referrals)) checked @endif
                                                    style="margin-left:5px;margin-top: 3px; " name="referral[]"
                                                    value="Drug Titration"><span style="margin-left:10px">Drug
                                                    Titration</span>
                                                <input type="checkbox" @if (in_array('Shared care', $referrals)) checked @endif
                                                    style="margin-left:5px;margin-top: 3px; " name="referral[]"
                                                    value="Shared care"><span style="margin-left:10px">Shared care</span>
                                                <input type="checkbox" @if (in_array('Long term care', $referrals)) checked @endif
                                                    style="margin-left:5px;margin-top: 3px; " name="referral[]"
                                                    value="Long term care"><span style="margin-left:10px">Long term
                                                    care</span>
                                                <input type="checkbox" @if (in_array('RPMS', $referrals)) checked @endif
                                                    style="margin-left:5px;margin-top: 3px; " name="referral[]"
                                                    value="RPMS"><span style="margin-left:10px">RPMS</span>
                                                <input type="checkbox" @if (in_array('Acute Care', $referrals)) checked @endif
                                                    style="margin-left:5px;margin-top: 3px; " name="referral[]"
                                                    value="Acute Care"><span style="margin-left:10px">Acute Care</span>
                                                <input type="checkbox" @if (in_array('Others', $referrals)) checked @endif
                                                ...
                                                <input type="text" name="other" id="ref_other"
                                                    value="{{ $patient->primaryDiseases->others }}" placeholder="Others"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row gutters">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td><input @if ($patient->concernDiseases->inform_diagnosis == 'Yes') checked @endif type="radio"
                                                    name="informdiagnosis" value="Yes"></td>
                                            <td><input @if ($patient->concernDiseases->inform_diagnosis == 'No') checked @endif type="radio"
                                                    name="informdiagnosis" value="No"></td>
                                        </tr>
                                        <tr>
                                            <td>Has patient been informed of prognosis</td>
                                            <td><input @if ($patient->concernDiseases->inform_prognosis == 'Yes') checked @endif type="radio"
                                                    name="informprognosis" value="Yes"></td>
                                            <td><input @if ($patient->concernDiseases->inform_prognosis == 'No') checked @endif type="radio"
                                                    name="informprognosis" value="No"></td>
                                        </tr>
                                        <tr>
                                            <td>Has family been informed of diagnosis</td>
                                            <td><input @if ($patient->concernDiseases->inform_diagnosis_family == 'Yes') checked @endif type="radio"
                                                    name="informdiagnosisfamily" value="Yes"></td>
                                            <td><input @if ($patient->concernDiseases->inform_diagnosis_family == 'No') checked @endif type="radio"
                                                    name="informdiagnosisfamily" value="No"></td>
                                        </tr>
                                        <tr>
                                            <td>Has family been informed of prognosis</td>
                                            <td><input @if ($patient->concernDiseases->inform_prognosis_family == 'Yes') checked @endif type="radio"
                                                    name="informprognosisfamily" value="Yes"></td>
                                            <td><input @if ($patient->concernDiseases->inform_prognosis_family == 'No') checked @endif type="radio"
                                                    name="informprognosisfamily" value="No"></td>
                                        </tr>
                                    </table>
                                </div>
                                <div class="text-center"><button class="btn btn-success btn-lg">Submit</button></div>
                                ...
                                <div class="row gutters">
                                    <div class="row gutters">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text custom-group-text">Surgery Name:</span>
                                                ...
                                                <table class="table table-striped">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="radio"
                                                                ...
                                                                name="symptomsshortofbreath" value="0 Not at all"></td>
                                                        <td><input type="radio"
                                                        ...
                                                        <td><input type="radio"
                                                                ...
                                                                name="symptomsshortofbreath" value="2 Moderately"></td>
                                                        <td><input type="radio"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="radio"
                                                                ...
                                                                name="symptomsweaknessenergy" value="0 Not at all"></td>
                                                        <td><input type="radio"
                                                        ...
                                                        <td><input type="radio"
                                                                ...
                                                                name="symptomsweaknessenergy" value="2 Moderately"></td>
                                                        <td><input type="radio"
                                                        ...
                                                        <td><input type="radio"
                                                                ...
                                                                name="symptomsweaknessenergy" value="4 Overwhelmingly">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="radio"
                                                                ...
                                                                name="symptomsconstipation" value="4 Overwhelmingly"></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="radio"
                                                                ...
                                                                name="symptomsdrowsiness" value="4 Overwhelmingly"></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><input type="radio"
                                                                ...
                                                                name="symptomsmorbility" value="4 Overwhelmingly"></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="radio" @if ($patient->functionStatus->mobility == 'Bed bound') checked @endif
                                                style="margin-left: 5px;margin-top: 3px;" name="Mobility"
                                                value="Bed bound"><span style="margin:0px 20px 0px 2px">Bed bound</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="radio" @if ($patient->functionStatus->feeding == 'Totally dependent') checked @endif
                                                style="margin-left: 5px;margin-top: 3px;" name="Feeding"
                                                value="Totally dependent"><span style="margin:0px 20px 0px 2px">Totally
                                                dependent</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <label class="">Medical accessory needed :</label> <input type="checkbox"
                                            class="" name="accessory[]" value="Feeding Tube"><span
                                            style="margin:0px 20px 0px 2px">Feeding Tube</span>
                                        ...
                                        <input type="text" name="accessoryneeded_other"
                                            value="{{ $patient->functionStatus->others }}" id="accessory_other_detail"
                                            class="form-control" placeholder="Medical Accessory Other Details">
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <div class="form-input">
                                                <label class="">Previous medication name :</label>
                                                <input value="{{ $patient->functionStatus->previous_medication ?? '' }}"
                            ...
                            <section>
                                <div class="row gutters">
                                                            ...
                                                            @foreach ($problems as $key => $problem)
                                                                ...
                                                                <div class="input-group"
                                                                    ...
                                                                    <input name="current_problem[]"
                                                                        ...
                                                                        class="form-control" value="{{ $problem }}">
                                    ...
                                    <div class="text-center"><button class="btn btn-success btn-lg">Submit</button>
                                    </div>
                            </section>
                        </div>
                        <!-- Table container end -->
